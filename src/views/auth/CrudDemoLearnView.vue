    ...
    function GetUserInfo() {
      getLabel().then(
          (response: { data: any; code: any; }) => {
            ...
            console.log(data)
            data.forEach(
                (element: { userName: any; roleName: any; subsystem: any; operationType: any; createTime: any; }) => {
                  tableData.push(
                      {
                        id: element.userName,
                        name: element.roleName,
                        price: element.subsystem,
                        isSold: element.operationType,
                        LoadingDate: element.createTime
                      }
                  );
                }
            );
